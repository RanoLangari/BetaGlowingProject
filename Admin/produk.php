...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="produk.html"><i
                                class="fas fa-list"></i><span>Produk</span></a></li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        aria-expanded="false" data-bs-toggle="dropdown" href="#"><span
                                            class="d-none d-lg-inline me-2 text-gray-600 small"><?=$row["username"]?></span><?php echo "<img class='border rounded-circle img-profile' src='assets/img/profile/".$row['gambar']."''>";?></a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td><?= $brng["kategori"]?></td>
                                <td>
                                    <button data-toggle="modal" data-target="#edit<?= $brng["id"]; ?>"
                                        class="btn btn-warning">Edit</button> ||
                                    <button data-toggle="modal" data-target="#hapus<?= $brng["id"]; ?>"
    ...
    <!-- Modal Edit Data -->
    <div class="modal fade" id="edit<?= $brng["id"]; ?>">
            ...
            <div class="modal-content">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" id="jumlah" name="jumlah" class="form-control-file"
                            value="<?=$brng['jumlah'] ?>">
                        <label for="harga">Harga</label>
                        <input type="text" id="harga" name="harga" class="form-control-file"
                            value="<?=$brng['harga'] ?>">
                        <label for="kategori">Kategori</label>
                        <input type="text" id="kategori" name="kategori" class="form-control-file"
                            value="<?=$brng['kategori'] ?>">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-warning" name="UbahBrng"
    ...
    <!-- Modal hapus Data -->
    <div class="modal fade" id="hapus<?= $brng["id"]; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post">
